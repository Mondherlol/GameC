...
set scenes=src\engine\scenes\scenes.c src\engine\scenes\menu_screen.c
set audio=src\engine\audio\audio.c
set files=src\glad.c src\main.c src\engine\global.c %render% %io% %config% %input% %time% %physics% %array_list% %entity% %animation% %my_curl% %scenes% %audio%
